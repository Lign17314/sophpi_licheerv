...
enum APPLICATION_CMD
{
    ...
    APP_CMD_HOST_OTA        = 13,
    APP_CMD_HOST_FW_OTA     = 14,
    APP_CMD_HOST_SET_IP     = 15,
    APP_CMD_START_P2PGO     = 16,
    APP_CMD_STOP_P2PGO      = 17,
    APP_CMD_START_RFTEST    = 18,
    APP_CMD_START_HOSTBT    = 19,
    APP_CMD_STOP_HOSTBT     = 20,
};
...
enum CUSTOM_CMD_TAG
{
    ...
    CUST_CMD_HTTP_REQ,
    CUST_CMD_HTTP_CFM,
    CUST_CMD_HTTP_RESP_IND,
    CUST_CMD_GET_FW_VERSION_REQ,
    CUST_CMD_GET_FW_VERSION_CFM,
    CUST_CMD_RESET_REQ,
    CUST_CMD_RESET_CFM,
    CUST_CMD_START_P2PGO_REQ,
    CUST_CMD_START_P2PGO_CFM,
    CUST_CMD_START_P2PGO_IND,
    CUST_CMD_STOP_P2PGO_REQ,
    CUST_CMD_STOP_P2PGO_CFM,
    CUST_CMD_STOP_P2PGO_IND,
    CUST_CMD_START_RFTEST_REQ,
    CUST_CMD_START_RFTEST_CFM,
    CUST_CMD_HOSTBT_CHANNEL_REQ,
    CUST_CMD_HOSTBT_CHANNEL_CFM,
    CUST_CMD_HOSTBT_CHANNEL_IND,
    CUST_CMD_START_HOSTBT_REQ,
    CUST_CMD_START_HOSTBT_CFM,
    CUST_CMD_STOP_HOSTBT_REQ,
    CUST_CMD_STOP_HOSTBT_CFM,

    // User defined message
    CUST_CMD_FIRST_USER_DEFINED = (TASK_CUSTOM) + 0x200,
...
// wifi rftest enable status
enum WIFI_RFTEST_ENABLE_STATUS
{
    RFTEST_DISABEL,
    RFTEST_ENABLE,
};
...
struct custom_msg_hostbt_channel_ind
{
    u32_l data_len;
    u8_l bt_data[1024];
};
...
{
    struct scan_wifi_result_cfm cfm[32];
    uint8_t  scan_num;
};
...
struct custom_msg_hostbt_channel_req
{
    struct custom_msg_hdr hdr;
    u32_l data_len;
    u8_l bt_data[1024];
...
typedef struct _aicwf_custom_msg_vnet {
    ...
    uint8_t scan_pkt_recv_num;
    uint8_t wlan_status;
    uint8_t wlan_conn_fail_result;
    uint8_t ble_status;
    bool    driver_insmod_ready;
    ...
    struct scan_wifi_result_cfm *scan_wifi_cfm_ptr;
    struct custom_msg_scan_wifi_result_cfm scan_wifi_cfm;
    #ifdef CONFIG_HOSTBT
    struct custom_msg_hostbt_channel_ind *hostbt_channel_ind;
    #endif
